...
class ProductItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val productAmountMinus: Button = itemView.findViewById(R.id.product_amount_minus_id)
    private val productAmountText: TextView = itemView.findViewById(R.id.product_amount_text_id)
    private val productAmountPlus: Button = itemView.findViewById(R.id.product_amount_text_id)
    private val productSum: TextView = itemView.findViewById(R.id.product_sum_id)
    private val productClear: Button = itemView.findViewById(R.id.product_clearBtn_id)
